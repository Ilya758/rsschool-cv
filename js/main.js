document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log(
        'Самооценка: 150 / 150: \n- вёрстка валидная +10\n- вёрстка семантическая +20(больше 10 тегов, как заголовков, так и тематических)\n- для оформления CV используются CSS-стили +10\n- контент отцентрирован по середине страницы +10\n- вёрстка адаптивная вплоть до 250px +10\n- присутствует адаптивное бургер-меню(доступно при разрешении менее 576px) +10\n- фото автора присутствует, тег alt на месте +10\n- контакты для связи оформлены по схеме ul>li +10\n- CV содержит краткую информацию об авторе +10\n- присутствует пример кода +10\n- присутствуют ссылки на выполненные проекты с переходом на них в отдельной вкладке +10\n- резюме выполнено на английском языке +10\n- выполнены требования к Pull Request +10\n- дизайн соответствует текущим реалиям современной вёрстки +10'
    )
});
